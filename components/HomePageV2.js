        ...
        <header className={styles.upcomingAgendaHead}>
          ...
          <p>{multipleLive
            ...
            : featuredOuting
              ...
              : 'Las próximas procesiones se muestran con el mismo peso visual y en orden cronológico. La cercanía de una cita no la convierte por sí sola en protagonista.'}</p>
        </header>

...
-- CANDIDATO APPLY. NO EJECUTAR SIN AUTORIZACIÓN EXPRESA. TERMINA EN COMMIT.
...
-- GENERADO desde el preflight certificado; no ejecutado al crear este archivo.
...
select
  'APPLY_CARMONA_SQL_OK_COMMITTED' as result,
  530 as logical_dml,
  75 as entities,
  11 as new_outings,
  129 as source_links,

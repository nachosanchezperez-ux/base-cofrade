...
insert into public."sources" ("id", "name", "url", "source_type", "author_or_publisher", "accessed_at", "notes")
values ('64288517-7b12-4495-a8d9-3c9034b680ba', 'Capilla Musical Gólgota y Vera+Cruz', 'https://capillamusicalgolgota.blogspot.com/2011/04/semana-santa-2011.html', 'web', 'Capilla Musical Gólgota', '2026-09-14', 'Archivo de la propia formación que documenta su vínculo con la Vera+Cruz; la vigencia se formula con cautela editorial.') on conflict ("id") do update set "name" = excluded."name", "url" = excluded."url", "source_type" = excluded."source_type", "author_or_publisher" = excluded."author_or_publisher", "accessed_at" = excluded."accessed_at", "notes" = excluded."notes";

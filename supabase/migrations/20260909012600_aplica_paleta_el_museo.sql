...
begin
  ...
  where e.slug = 'el-museo'
  limit 1;

  if target_id is null then
    raise exception 'No se encuentra El Museo';
  end if;
  ...
  where brotherhood_entity_id = target_id
    ...
    and color_name not in ('Negro', 'Blanco', 'Dorado');
  ...
  values
    (target_id, 'Negro', '#111111', 'primary', 10, 'Base estructural de la identidad visual de la Hermandad.', 'published'),

...
-- Perfil y trayectoria de Personas / agentes.
...
-- Autorías de Imágenes. La autoría anónima no necesita agente.
...
-- Compositores y demás créditos de Marchas.
...
-- Capataces y demás responsables de Pasos.
...
-- Artesanos y responsables de fases patrimoniales de Pasos.
...
-- Intervenciones patrimoniales estructuradas.
...
-- Agentes vinculados a novedades patrimoniales de Hermandades.
...
-- Dirección y responsabilidades públicas de Bandas.
...
-- Relaciones genéricas consumidas por Tira del hilo y fichas públicas.

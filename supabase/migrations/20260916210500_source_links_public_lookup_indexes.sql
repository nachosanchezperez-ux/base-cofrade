-- Evita escaneos completos de source_links en las fichas públicas.
-- La política RLS pública valida el destino de cada enlace; sin estos índices,
-- las consultas por entidad/culto/patrimonio podían agotar statement_timeout.

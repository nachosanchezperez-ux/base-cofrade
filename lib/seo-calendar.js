...
export function agendaSeoCopy(year = madridYear()) {
  return {
    ...
    description: 'Consulta los próximos actos cofrades de Sevilla y su provincia: procesiones, traslados, rosarios públicos, besamanos, besapiés y conciertos de bandas.',
  }
}

export function extraordinarySeoCopy(year = madridYear()) {
  return {
    title: `Procesiones y salidas extraordinarias de Sevilla ${year}`,

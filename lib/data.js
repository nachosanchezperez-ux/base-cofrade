export const hermandades = [{
  ...
  pasos:[
    {id:'PASO0001',slug:'paso-de-la-piedad',nombre:'Paso del Santísimo Cristo de la Misericordia y Nuestra Señora de la Piedad',tipo:'Misterio / Piedad',imagenes:['IMG0001','IMG0002'],descripcion:'Paso que representa la Piedad. Su ficha reunirá patrimonio, autores, intervenciones y evolución.',capatazActual:'Pendiente de incorporar',acompanamientoActual:'Pendiente de incorporar'},
  ...
  acompanamientoActual:[
    ...
    {id:'AMU0002',posicion:'Paso de Cristo o Misterio',banda:'Pendiente de incorporar',tipo:'Pendiente de definir',observaciones:''},
  ...
  salidas:[
    {id:'SAL0001',nombre:'Estación de Penitencia',tipo:'Estación de penitencia',caracter:'Ordinaria',titulares:'Santísimo Cristo de la Misericordia, Nuestra Señora de la Piedad y María Santísima de la Caridad en su Soledad',momento:'Miércoles Santo',destino:'Santa Iglesia Catedral de Sevilla'},
    {id:'SAL0002',nombre:'Traslado para los cultos cuaresmales',tipo:'Traslado',caracter:'Ida',titulares:'Nuestra Señora de la Piedad y Santísimo Cristo de la Misericordia',momento:'Primer sábado de Cuaresma, a la finalización del último día del Quinario.'},
    {id:'SAL0003',nombre:'Regreso a la Capilla de la Piedad',tipo:'Traslado',caracter:'Regreso',titulares:'Nuestra Señora de la Piedad y Santísimo Cristo de la Misericordia',momento:'El domingo siguiente, a la finalización de la celebración de la Función Principal de Instituto.',destino:'Capilla de la Piedad'},
    {id:'SAL0004',nombre:'Traslado para los cultos en su honor',tipo:'Traslado',caracter:'Ida',titulares:'María Santísima de la Caridad en su Soledad',momento:'El sábado en el que se celebra el último día del Triduo en su honor.'},
    {id:'SAL0005',nombre:'Regreso a la Capilla de la Piedad',tipo:'Traslado',caracter:'Regreso',titulares:'María Santísima de la Caridad en su Soledad',momento:'El domingo siguiente, a la finalización de la celebración de la Función Solemne.',destino:'Capilla de la Piedad'}
  ],
  cultos:[

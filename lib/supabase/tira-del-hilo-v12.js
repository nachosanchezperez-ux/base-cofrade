...
export async function askHiloCofradeV12(question, context = null) {
  ...
  // Una Marcha puede tirar del hilo hacia sus crucetas, Bandas, dedicatorias y
  // otras obras del mismo compositor sin convertir una consulta básica en una búsqueda pesada.

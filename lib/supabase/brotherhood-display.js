...
export async function getHermandadPageBySlug(slug) {
  ...
  const display = await enrichBrotherhoodDisplay(hermandad).catch((error) => {
  ...
  // El filtrado de Fuentes heredadas se realiza una sola vez al final del
  // orquestador público, cuando ya están disponibles todas las relaciones.
  return display
}

  ...
  try {
    ...
    return entities.map((entity) => {
      ...
      return {
        ...
        barrio: brotherhood.neighborhood || '', diaSalida: brotherhood.current_procession_day || 'Fecha por documentar',
        tipos: brotherhood.brotherhood_types || [], escudoPath: brotherhood.crest_path || LOCAL_CREST_PATHS[entity.slug] || null,

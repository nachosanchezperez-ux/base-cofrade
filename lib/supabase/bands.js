...
async function loadBandRelations(supabase, band) {
  const [directionResult, periodResult, premiereResult, assignmentResult, heritageResult] = await Promise.all([
  ...
  const heritageRows = assertQuery(heritageResult, 'No se pudo cargar el patrimonio de la banda')

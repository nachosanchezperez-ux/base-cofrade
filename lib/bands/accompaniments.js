 ...
 * literal la jornada o el tipo ya mostrado en la cabecera de la tarjeta.
 * Las frases que añaden contexto (por ejemplo, «Madrugá y mañana») se
 * conservan completas.
 */
...
function normalizeAccompaniment(item = {}) {
  return {
    ...item,
    outingType: resolveAccompanimentOutingType(item),
  }
}

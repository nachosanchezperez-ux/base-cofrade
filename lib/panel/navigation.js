export const PANEL_NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: '/panel/conciertos',
        label: 'Conciertos',
        mark: '♪',
        description: 'Agenda musical, certámenes y encuentros de bandas',
      },
      {
      ...
      {
        href: '/panel/igualas-y-ensayos',
        label: 'Igualás y ensayos',
        mark: 'I/E',
        description: 'Convocatorias, Pasos y equipos de capataces',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'Legal',
        mark: 'L',
        description: 'Borradores legales y privacidad',
      },
      {
        href: '/panel/aportaciones',
        label: 'Aportaciones',
        mark: 'Ap',
        description: 'Colaboraciones públicas en revisión',
      },
    ],
  },
  {
...
const DASHBOARD_GROUP_ORDER = [
  ...
  {
    label: 'Contenido',
    hrefs: ['/panel/glorias', '/panel/marchas', '/panel/conciertos', '/panel/extraordinarias', '/panel/igualas-y-ensayos', '/panel/acontecimientos', '/panel/hoy'],
  },
  {
    label: 'Documentación',
    hrefs: ['/panel/agentes', '/panel/fuentes', '/panel/multimedia', '/panel/relaciones', '/panel/aportaciones', '/panel/legal'],
  },
  {
    label: 'Sistema',

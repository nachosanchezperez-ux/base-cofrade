...
export async function getBandEditorData(id) {
  ...
  const [bandResult, namesResult, directionResult, periodsResult, premieresResult, assignmentsResult, municipalitiesResult, brotherhoodEntitiesResult] = await Promise.all([

...
export async function getBandEditorData(id) {
  ...
  const [bandResult, namesResult, directionResult, periodsResult, premieresResult, assignmentsResult, heritageAssetsResult, municipalitiesResult, brotherhoodEntitiesResult, agentEntitiesResult, linkedBrotherhoodRelationResult] = await Promise.all([

...
Relaciones permitidas: has_titular (Hermandad→advocation), titular (Hermandad→image), processional_step (Hermandad→step), processes_on (image→step), belongs_to_brotherhood (band→Hermandad), authored_by (march→agent), image_authored_by (image→agent, autoría documentada), image_attributed_to (image→agent, atribución no documental), dedicated_to (march→entidad).

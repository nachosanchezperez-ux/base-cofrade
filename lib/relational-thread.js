...
export const RELATIONAL_THREAD_PROFILES = {
  hermandad: {
    ...
    caps: { imagen: 2, paso: 2, banda: 2, marcha: 2 },
  },
  imagen: {
  ...
  banda: {
    order: { hermandad: 10, paso: 20, cruceta: 30, marcha: 40, autor: 50 },
    caps: { hermandad: 2, paso: 2, cruceta: 2, marcha: 2 },
  },
  marcha: {
    order: { compositor: 10, dedicatoria: 20, banda: 30, cruceta: 40, discografia: 50 },
    caps: { compositor: 1, dedicatoria: 2, banda: 2, cruceta: 2, discografia: 1 },
  },
};

...
const FOLLOW_UP_START = /^(?:quien|quienes|cual|cuales|que|a quien|a quienes|a cual|a cuales|en que|en cual|en cuales|con que|con cual|con cuales|de que|de cual|de cuales|desde cuando|cuando|compar\w*|orden\w*|ensena\w*|muestra\w*|dime\b|cuentame\b|filtra\w*|solo\b)/

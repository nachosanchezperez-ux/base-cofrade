...
const septemberCallsMigrationPath = new URL('../supabase/migrations_archive/post-first-edition-editorial/20260831074355_publica_tres_igualas_septiembre_2026.sql', import.meta.url)
const pastoraTrianaMigrationPath = new URL('../supabase/migrations_archive/post-first-edition-editorial/20260831213932_publica_iguala_divina_pastora_triana_2026.sql', import.meta.url)

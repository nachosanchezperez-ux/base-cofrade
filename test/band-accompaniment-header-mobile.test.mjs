...
test('Redención incorpora Monte-Sión y La Milagrosa al histórico hasta 2025', () => {
  const migration = read('supabase/migrations/20260830233859_redencion_historicos_montesion_milagrosa_2025.sql')
...
test('las etiquetas sin fecha inicial se compactan antes de llegar a la cabecera', () => {
  const migration = read('supabase/migrations/20260830234116_compact_band_period_labels_2026.sql')

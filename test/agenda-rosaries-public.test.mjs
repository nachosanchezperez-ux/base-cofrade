...
test('Agenda expone rosarios en navegación, sitemap y fichas SEO propias', () => {
  ...
  const directory = read('components/RosaryDirectory.js')
  ...
  assert.match(page, /Rosarios públicos en Sevilla y su provincia/)
  assert.match(directory, /Solo recorridos por las calles presididos por una imagen o Simpecado/)

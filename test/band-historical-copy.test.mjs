...
const migration = readFileSync(new URL('../supabase/migrations_archive/post-first-edition-editorial/20260902090401_normaliza_textos_historicos_bandas.sql', import.meta.url), 'utf8')

    ...
    <article className={styles.editorItem}>
      ...
      <form action={saveBandDirectionAction} className={styles.editorForm}>
        ...
        <div className={styles.formGrid}>
          ...
          <label className={styles.checkboxField}><input name="is_current" type="checkbox" defaultChecked={item.is_current} /><span>Responsabilidad vigente</span></label>
          <label className={styles.checkboxField}><input name="is_public" type="checkbox" defaultChecked={item.is_public !== false} /><span>Visible públicamente</span></label>
        </div>
    ...
    <article className={styles.editorItem}>
      ...
      <form action={saveBandDirectionAction} className={styles.editorForm}>
        ...
        <div className={styles.formGrid}>
          ...
          <label className={styles.checkboxField}><input name="is_current" type="checkbox" defaultChecked /><span>Responsabilidad vigente</span></label>
          <label className={styles.checkboxField}><input name="is_public" type="checkbox" defaultChecked /><span>Visible públicamente</span></label>
        </div>
...
export default async function BandDirectionPage({ params, searchParams }) {
  ...
  const sourceSupport = await loadRelationSourceSupport(supabase, data.direction, 'band_agent')
  ...
  const agentOptions = data.agents.map((agent) => ({ id: agent.id, name: agent.name, slug: agent.slug, meta: agent.status === 'published' ? 'Persona/Agente' : agent.status }))

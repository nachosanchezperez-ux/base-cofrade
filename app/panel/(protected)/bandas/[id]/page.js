...
export default async function BandEditorPage({ params, searchParams }) {
  ...
  return <div className={styles.pageWrap}>
    ...
    <nav className={styles.sectionTabs} aria-label="Secciones de la ficha"><a href="#general">General</a><a href="#banderin">Banderín</a><a href="#acompanamientos">Acompañamientos</a><a href="#extraordinarias">Extraordinarias</a><a href="#estrenos">Estrenos</a><a href="#direccion">Dirección</a></nav>

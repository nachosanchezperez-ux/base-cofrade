...
export default async function PanelMasterDataPage({ searchParams }) {
  ...
  return <div className={styles.pageWrap}>
    ...
    <section className={styles.editorSection}>
      ...
      <div className={styles.panelCard}><div className={styles.moduleList}>
        <ModuleRow href="/panel/datos/ingestion" label="Ingestión asistida" count="URL → lote" note="Captura Fuentes, extrae propuestas con evidencia, resuelve entidades y entrega un lote al preflight existente" />

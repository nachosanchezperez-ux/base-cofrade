    ...
    <div className={styles.pageWrap}>
      ...
      <section className={styles.editorSection} id="general">
        ...
        <form action={updateImageAction} className={`${styles.panelCard} ${styles.editorForm}`}>
          ...
          <PanelFormGroup
            eyebrow="Identidad"
            title="Datos editoriales"
            description="Nombre, clasificación y textos principales que identifican la Imagen en Hilo Cofrade."
          >
          ...
          <PanelFormGroup
            eyebrow="Datación y técnica"
            title="Características materiales"
            description="Información técnica y dimensional que documenta la ejecución de la obra."
          >
          ...
          <PanelFormGroup
            ...
            title="Estado actual"
            description="Distingue la información pública de las observaciones internas de seguimiento."
          >

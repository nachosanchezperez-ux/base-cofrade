    ...
    <div className={styles.pageWrap}>
      ...
      <section className={styles.editorSection} id="portada">
        <div className={styles.sectionHeading}>
          <div>
            <span className={styles.eyebrow}>Presentación visual</span>
            <h2>Portada</h2>
          </div>
          <p>Sube la fotografía, documenta su crédito y ajusta el encuadre para escritorio y móvil.</p>
        </div>
      ...
      <section className={styles.editorSection} id="general">
        <div className={styles.sectionHeading}>
          ...
          <p>Nombre, tipología y URL pública de la imagen.</p>
        </div>

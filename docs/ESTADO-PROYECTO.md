...
**Corte operativo:** 14 de septiembre de 2026 · cierre del macrolote transversal HC-016 del Jueves Santo de Sevilla

**HEAD de partida auditado:** `bbfa0adc5592f802df3409f6e0f2baec114a12a7`

**Producción de partida auditada:** `READY` · deployment `dpl_ALaSnrZDwzNjrRCdnZ5pD2erC7CE` · SHA `bbfa0adc5592f802df3409f6e0f2baec114a12a7`
...
> GitHub, Vercel y Supabase prevalecen sobre cualquier fotografía anterior. El SHA de partida de esta fotografía es `bbfa0adc…`; el commit que contenga este tablero pasa a ser el HEAD canónico cuando `main` y producción vuelvan a coincidir. Los trece contextos HC-016 permanecen cerrados; todas las jornadas ordinarias de Domingo de Ramos a Sábado Santo, incluida la Madrugá, quedan cubiertas mediante macrolotes transversales y la Sagrada Resurrección conserva su cierre individual.
...
| **CERRADO** | Macrolote transversal HC-016 · Martes Santo de Sevilla | 224/224 operaciones gobernadas, 0 inválidas, 0 fallos; Candelaria, Los Javieres y Los Estudiantes completadas; cinco cierres previos preservados; directorio `Martes Santo · 8` | No reabrir las ocho corporaciones como frentes separados; cualquier nueva jornada exige recálculo y orden expresa |
| **CERRADO** | Macrolote transversal HC-016 · Miércoles Santo de Sevilla | 153/153 operaciones gobernadas, 0 inválidas, 0 fallos; El Buen Fin publicado con separación estricta de la Dolorosa homónima de la Lanzada; ocho cierres previos preservados; directorio `Miércoles Santo · 9` | No reabrir las nueve corporaciones como frentes separados; cualquier nueva jornada exige recálculo y orden expresa |
| **CERRADO** | Macrolote transversal HC-016 · Domingo de Ramos de Sevilla | 261/261 operaciones gobernadas, 0 inválidas, 0 fallos; seis fichas completadas, La Paz y Jesús Despojado preservadas; ocho corporaciones y nueve cortejos | La Borriquita sigue dentro del Amor; no reabrir la jornada ni abrir Jueves o Viernes sin orden nueva |
...
| **CERRADO** | HC-020 · Agenda Cofrade | Centro único para Extraordinarias, Glorias, rosarios públicos, igualás y ensayos, con cronología y filtros de hoy, fin de semana, tipo y territorio | Agregar próximas familias sobre el modelo canónico; no duplicar actos ni crear calendarios paralelos |
...
- GitHub: `main` partía de `bbfa0adc5592f802df3409f6e0f2baec114a12a7`; #749–#776 están fusionadas, #492 está cerrada y la cola vuelve a 0 PR abiertas al integrar este cierre. El commit final prevalece.
- Vercel: la producción de partida estaba `READY` mediante `dpl_ALaSnrZDwzNjrRCdnZ5pD2erC7CE`, exactamente sobre `bbfa0adc5592f802df3409f6e0f2baec114a12a7`, sin errores runtime en la última hora. La certificación final exige que el nuevo deployment alcance el SHA fusionado.
- Supabase: proyecto `Hilocofrade` `ACTIVE_HEALTHY`. Jueves Santo figura `completed` mediante 223/223 operaciones gobernadas, 0 inválidas y 0 fallos. Sus siete corporaciones están publicadas y clasificadas en la jornada; 0 slugs duplicados, 0 huérfanos y 0 contaminación entre homónimos. Los cierres anteriores permanecen preservados.
...
- Git ↔ Supabase: siguen vigentes las cuatro migraciones estructurales reconciliadas en #730 y las dos posteriores de HC-019. El cierre de Jueves Santo se realizó exclusivamente mediante DML gobernado y su receta queda archivada fuera de la cadena estructural activa.
...
- HC-020 · Agenda Cofrade: centro provincial único con Extraordinarias, Glorias, rosarios públicos, igualás y ensayos; preguntas «qué ver hoy» y «este fin de semana» y filtros territoriales sin duplicar datos.
...
## Noveno lote HC-016 · Divina Pastora de Santa Marina

La ficha partía de H2, con sede, Paso, tres Cultos, tres Salidas y música parcialmente documentados, pero sin titular canónica publicada ni grafo completo entre Imagen, Paso, Cultos, Salida y acompañamientos. El lote principal `89efa9ed-4ad7-4893-8686-30fb1dc831b1` terminó 43/43, con 34 insert y 9 update. Los remates `f5c7e46f-55eb-4ba1-a539-ab113e1a4581` y `e40b665a-68ef-495e-bbe6-fc51ddfd56ff` sumaron 2/2 y 5/5. El balance final es **50/50**, 41 insert, 9 update, 0 inválidas, 0 fallos y 0 operaciones pendientes.

Se publicó la titular como Divina Pastora de las Almas de Santa Marina, atribuida prudentemente a Francisco Antonio Ruiz Gijón hacia 1704–1705, y su restauración por Juan Manuel Miñarro López en 1991–1992. La Imagen quedó relacionada con la Hermandad, las andas de 1959–1960, los tres Cultos y la Salida principal. La procesión del 20 de septiembre de 2026 muestra a Santa Cecilia abriendo el cortejo y a la Banda Municipal de Coria del Río tras las andas. El Paso publica además sus candelabros y las coronillas realizadas por Orfebrería Andaluza en 2002.

La fotografía de Jl FilpoC, bajo CC BY-SA 4.0, se integró mediante #745 como cabecera de Hermandad y portada de la Imagen, con crédito y procedencia completos. Las tres fichas públicas responden 200 y son indexables; el OG devuelve PNG 1200 × 630. El grafo no contiene duplicados nucleares ni relaciones huérfanas y la señal reproducible de completitud alcanza **100 %**, por lo que la ficha queda en **H3**. Permanece como hueco legítimo una fotografía específica del Paso completo. La cronología temporal de sedes no se fuerza porque `entity_locations` está bloqueada para escritura por HC-016; la sede canónica ya consta en el campo vigente.

La evidencia completa está en [`CERTIFICACION-PASTORA-SANTA-MARINA-HC016-2026-09-11.md`](./CERTIFICACION-PASTORA-SANTA-MARINA-HC016-2026-09-11.md). El frente queda cerrado y no activa cambios de UX, arquitectura o funcionalidades.
...
| Puesto | Hermandad | Municipio | Deuda | Relaciones | Valor territorial | Fuentes | Riesgo |
|---:|---|---|---|---|---|---|---|
| **1** | **Santo Entierro** | Dos Hermanas | Muy alta | Muy altas | Máximo | Medias-altas | Medio-alto |
...
## Recálculo territorial que seleccionó el decimotercer contexto

El nuevo corte volvió a medir Sevilla capital, La Rinconada, Dos Hermanas y Alcalá de Guadaíra sin favorecer Sevilla por volumen documental. La evidencia completa está en [`AUDITORIA-TERRITORIAL-DECIMOTERCERO-HC016-2026-09-14.md`](./AUDITORIA-TERRITORIAL-DECIMOTERCERO-HC016-2026-09-14.md). Este ranking queda como fundamento histórico y no constituye una cola operativa.

| Puesto | Hermandad | Municipio | Deuda | Relaciones | Valor territorial | Fuentes | Riesgo |
|---:|---|---|---|---|---|---|---|
| **1** | **Sagrada Resurrección** | Sevilla | Muy alta | Máximas | Medio-bajo | Muy altas | Medio |
| **2** | Santa Ana | Dos Hermanas | Alta | Altas | Máximo | Altas | Bajo-medio |
| **3** | Soledad de San Lorenzo | Sevilla | Muy alta | Muy altas | Bajo | Altas | Medio |
...
1. **¿Cuál es el HEAD real?** La base reconciliada es `bbfa0adc5592f802df3409f6e0f2baec114a12a7`; el SHA fusionado de este cierre prevalece al terminar el pipeline.
...
5. **¿#749–#776 están completamente absorbidas?** Sí, todas fusionadas en `main`.
...
8. **¿Queda algún frente activo?** No tras cerrar Jueves Santo.
9. **¿Qué cubre el último lote?** Las siete corporaciones del Jueves Santo: cinco fichas completadas y dos cierres preservados.
10. **¿Cuál es su resultado?** Un lote `completed`, 223/223 operaciones gobernadas, 0 inválidas y 0 fallos.
11. **¿Por qué es transversal?** Porque completa toda la deuda real de la jornada en un solo lote, reutiliza los nodos canónicos y no abre Hermandades aisladas.
...
No se activa un frente de Laboratorio. Los trece contextos y los ocho macrolotes transversales permanecen cerrados; la Sagrada Resurrección conserva además su cierre individual.

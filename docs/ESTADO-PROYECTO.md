...
**Corte GitHub del dry-run:** el ensayo se preparó sobre `c8208e71b37c11694239b406b620e39460e2b682`; al reconciliarlo, `main` había avanzado a `5cbc41a5decf61e29b476c628b4523e36be43e84` con cambios de Agenda/UX y tests, sin migraciones ni cambios de esquema. El cierre se reconstruyó sobre ese `main` vivo.

**Producción al reconciliar el dry-run:** `dpl_CT1rJ984dQT8nWhtDFaSRpVu3vba`, `READY`, sobre `5cbc41a5decf61e29b476c628b4523e36be43e84`; Supabase mantiene 17 migraciones y el contrato de Morón no ha variado.
...
**GitHub al reconciliar el dry-run:** el trabajo paralelo de Agenda/SEO permanece independiente; no se mezcla con Morón. #931 sigue cerrada sin merge como superseded por #968/#969.
...
**Frente ACTIVO:** HC-016 · Morón de la Frontera. DRY-RUN CERRADO Y CERTIFICADO: import `c0160037-0000-4000-8000-000000000001` · 504/504 válidas · 0 aplicadas · `DRY_RUN_MORON_SQL_OK_ROLLED_BACK` · 0 residuos. El primer intento detectó la secuencia duplicada de Jesús y abortó limpio; quedó corregida a Cruz de Guía 1 → Cristo 2 → Palio 3. Candidato Apply preparado y equivalente, **NO autorizado y NO ejecutado**. HC-AUTO-03 continúa bloqueado.
...
| **CERRADO** | HC-SEO/PERF · saneamiento de filtros, fichas y descubrimiento territorial · #966–#971 | Filtros combinatorios de Agenda/Bandas/Directorio conservan navegación pero usan `noindex, follow`; landings limpias mantienen canonical/indexación. #968 elimina lecturas redundantes en Bandas, acota/cachea Glorias e incorpora `preload` LCP; #969 reduce fan-out de Hermandades, Igualás y Discografía; #971 añade al sitemap los hubs municipales evergreen basados en Hermandades indexables. CI/build verdes; producción 200; Glorias verificadas MISS→HIT; sitemap Agenda 232 URLs/43 hubs; 0 errores runtime | #931 queda superseded y cerrada. Cualquier nueva optimización debe partir del `main` vigente y medirse de nuevo; no reabrir la rama histórica |
...
| **CERRADO** | Primer macrolote municipal HC-016 · Gerena | Lote `c0160026-0000-4000-8000-000000000001`: 83/83, 0 inválidas y 0 fallos; tres Hermandades, una Banda local, siete titulares, seis Pasos y relaciones municipales canónicas | Preservar; Agenda, Cultos fechados, igualás, conciertos y Crucetas permanecen como huecos legítimos sin convocatoria verificable |
...
10. **¿Queda algún frente activo?** No. Coria del Río está cerrada y certificada. No hay ningún municipio abierto; el siguiente análisis municipal debe recalcular la cobertura provincial desde cero.

## Cuarto macrolote provincial · selección

> **Fotografía histórica.** Este apartado documenta por qué se eligió Coria del Río. Tras #851 no mantiene abierto ningún municipio ni autoriza automáticamente Sanlúcar la Mayor o Utrera.
...
- Supabase conserva 0 staging editoriales activos; #899 permanece como PR independiente y la ventana runtime contiene incidencias previas no relacionadas con Carmona.

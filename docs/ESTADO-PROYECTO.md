...
**Frente editorial ACTIVO:** **Lebrija · sexto macrolote municipal HC-016 · MANIFIESTO 465/465 CERRADO**. **465 DML = 463 upsert + 2 update + 0 delete**, **32/32 REUSE**, namespace `c0160033-*` sin colisiones; manifest MD5 `12ab6ebe15a4f38459133352b5c4a88d`. **0 staging · 0 Apply**.
...
| **ACTIVO · MANIFIESTO CERRADO** | Sexto macrolote municipal HC-016 · Lebrija | IDs y slugs deterministas congelados; **465/465**, 463 upsert + 2 update, 32/32 REUSE, 0 colisiones; manifest MD5 `12ab6ebe15a4f38459133352b5c4a88d` | Siguiente puerta: **payload SQL exacto → transacción completa → QA → ROLLBACK**. **0 staging / 0 Apply** |
...
**Único frente editorial municipal activo: Lebrija · sexto macrolote HC-016 · MANIFIESTO 465/465 CERRADO.**
...
Siguiente movimiento: **generar payload SQL exacto desde el manifiesto 465/465 → ejecutar el payload completo dentro de una única transacción → QA interno → ROLLBACK → certificar 0 residuos**.

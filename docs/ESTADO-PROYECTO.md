...
**Base operativa del dry-run:** `main = c8208e71b37c11694239b406b620e39460e2b682` tras la reconciliación #975; el staging certificado de #974 permanece `ready 504/504 · 0 aplicado`.

**Producción al iniciar el dry-run:** `dpl_Gnhh81Ujz5bzkw4tuEFkM5V7cWXY`, `READY`, sobre `c8208e71b37c11694239b406b620e39460e2b682`; sin regresiones runtime en la ventana revisada.
...
**GitHub al iniciar el dry-run:** #974 y #975 fusionadas; 0 PR abiertas. #931 permanece cerrada sin merge como superseded por #968/#969.
...
**Frente ACTIVO:** HC-016 · Morón de la Frontera. DRY-RUN CERRADO Y CERTIFICADO: import `c0160037-0000-4000-8000-000000000001` · 504/504 válidas · 0 aplicadas · `DRY_RUN_MORON_SQL_OK_ROLLED_BACK` · 0 residuos. Candidato Apply preparado y equivalente, **NO autorizado y NO ejecutado**. HC-AUTO-03 continúa bloqueado.

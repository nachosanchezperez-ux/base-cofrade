...
- Rama principal: `main`.
- Último baseline funcional validado: `aa7514b18af5fec01b05c2e98133a24356632e00` — **Merge #404 · Hoy en Hilo Cofrade móvil**.
- Producción: `dpl_9TLZV8QCMNh5Xgje1WKeyGnXuFsZ` → **READY**, región `dub1`, commit `aa7514b`.

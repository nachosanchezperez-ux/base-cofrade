...
**TOTAL DML:** **465** = **463 upsert + 2 update + 0 delete**  
**REUSE:** **32**  
**Staging:** 0 · **Apply:** 0
...
- 31 URLs planificadas: 1 REUSE exacto + **30 nuevas**;
...
### outings nuevas · 13
`c0160033-0961-4000-8000-000000000001` → `c0160033-0973-4000-8000-000000000013`

REUSE/UPDATE:
- patronal Castillo 12/09/2026 · `8f15dc9a-697a-4639-8243-17a8d683c420`.

### outing_entities · 23
`c0160033-0981-4000-8000-000000000001` → `c0160033-1003-4000-8000-000000000023`.

## 13. Música

- positions: `c0160033-1011-4000-8000-000000000001` → `c0160033-1021-4000-8000-000000000011`.
- assignments: `c0160033-1031-4000-8000-000000000001` → `c0160033-1041-4000-8000-000000000011`.
- periods: `c0160033-1051-4000-8000-000000000001` → `c0160033-1061-4000-8000-000000000011`.
...
`c0160033-2001-4000-8000-000000000001` → `c0160033-2121-4000-8000-000000000121`
...
- 2088–2100 · 13 · outings;
- 2101–2111 · 11 · música;
- 2112–2116 · 5 · cults;
- 2117–2119 · 3 · occurrences;
- 2120–2121 · 2 · relaciones sacramentales.

## 16. Operaciones 464–465

### 464 · UPDATE brotherhoods · Castillo
...
### 465 · UPDATE outings · Castillo patronal
...
Siguiente puerta:
**construir el SQL exacto de las 465 DML → comprobar contrato BEGIN/ROLLBACK → ejecutar payload completo en producción con ROLLBACK → verificar 0 residuos**.

# Inventario canónico · Estepa · quinto macrolote municipal HC-016

**Fecha:** 19 de septiembre de 2026  
**Fase:** selección certificable / pre-lote  
**Staging:** NO  
**Apply:** NO  
**Esquema:** sin cambios

## Universo canónico congelado

Estepa queda delimitada en **13 corporaciones**.

La regla de identidad es especialmente importante en Paz y Caridad: la corporación asume además la procesión de la Inmaculada como quinta Gloria local, pero **no se crea una Hermandad independiente para la Inmaculada**.

### Penitencia · 9 corporaciones
...
| 6 | Franciscana Hermandad del Santísimo Cristo de la Salud, Nuestra Señora de la Amargura y San Juan Evangelista | Penitencia | Madrugada del Jueves Santo | Iglesia de Ntra. Sra. del Carmen | 3 | 1 |
| 7 | Archicofradía Sacramental de Paz y Caridad, de la Pura y Limpia Concepción de María y Real Hermandad de Nazarenos de la Santa Vera+Cruz, Santísimo Cristo Amarrado a la Columna y María Santísima de la Esperanza Coronada | Sacramental + Penitencia + Gloria propia | Jueves Santo | Iglesia de Ntra. Sra. de los Remedios | 3 | 2 |
...
Paz y Caridad organiza la procesión de la Inmaculada como quinta Gloria de Estepa: se modelará como actividad/Imagen de la corporación existente, no como una decimocuarta Hermandad.

## Estado actual en Hilo Cofrade

### Reutilizar / completar

**Hermandad de Jesús Nazareno de Estepa**
- entity_id: `25d7900f-5518-4e22-84a3-b5b3b44e9ab1`
- slug: `jesus-nazareno-estepa`
- estado: `published`
- sede: Iglesia de San Sebastián
- 1 Imagen publicada: Nuestro Padre Jesús Nazareno
- 1 Paso en `review`: Paso de Nuestro Padre Jesús Nazareno
- 2 Salidas extraordinarias futuras ya publicadas: 2 y 15 de noviembre de 2026
- 3 Fuentes directas actualmente vinculadas

La ficha pública responde 200, publica canonical propio e `index, follow`.

### Ausentes como corporación

Las otras **12 corporaciones** no existen en Hilo Cofrade bajo identidad canónica ni como Hermandades ocultas por nombre/slug.
...
Faltan como lugares canónicos municipales:
- Ermita de Santa Ana;
...
### Verificados para la Semana Santa 2026
...
### Formaciones locales candidatas a alta

No existen actualmente como Bandas municipales de Estepa:

1. Banda de Música de Estepa (BAME).
2. Agrupación Musical Paz y Caridad.
...
| Jornada | Corporación | Acompañamiento 2026 | Modelo previsto |
|---|---|---|---|
| Domingo de Ramos | Borriquita | BCT Santa Bárbara · La Línea | crédito textual salvo identidad global resuelta |
| Lunes Santo | Angustias | tambores destemplados fúnebres | crédito textual; no Banda |
| Martes Santo | San Pedro | BCT Vera+Cruz de Utrera + BAME | textual + Banda local |
| Madrugada Miércoles | Estudiantes | sin Banda; tambor ronco | NO APLICA Banda |
| Miércoles Santo | Dulce Nombre | AM Dulce Nombre + BAME | 2 Bandas |
| Madrugada Jueves | Calvario | Capilla Musical Ntra. Sra. de la Victoria | Banda/formación local |
| Jueves Santo | Paz y Caridad | AM Paz y Caridad + BAME | 2 Bandas |
...
Ya existen y pueden reutilizarse cuando la autoría esté respaldada por Fuente:
...
Candidatos ausentes, solo si se necesitan para autorías verificadas:
- Diego Márquez;
- Pedro de Mena;
- Francisco Sánchez Aracil;
- Andrés de Carvajal.
...
El Ayuntamiento publicó el programa 2026 y, el 5 de abril, agradeció expresamente a las nueve Hermandades que conforman la Semana Santa después de siete días de procesiones y actos.

El futuro lote puede preparar **9 Salidas de Semana Santa 2026**, con estado individual condicionado a la evidencia posterior concreta. La fecha pasada no bastará por sí sola para `held`.
...
Ya existen en Hilo dos Salidas anunciadas:
- 2 de noviembre de 2026;
- 15 de noviembre de 2026.

No se duplican.

Existe además una conferencia oficial del 25 de septiembre dentro del 400.º aniversario fundacional. Puede entrar como acontecimiento si el futuro preflight confirma que no existe ya un evento equivalente.

## Matriz de Fuentes

Estados: VERIFICADO / PARCIAL / AUSENTE / NO APLICA.

| Corporación | Fuente principal | Fuente secundaria | Identidad | Titulares | Pasos | Música | Cultos | Salidas | Historia |
|---|---|---|---|---|---|---|---|---|---|
| Borriquita | Ayuntamiento · ficha | Programa 2026 | VERIFICADO | VERIFICADO | VERIFICADO | VERIFICADO | AUSENTE | VERIFICADO | VERIFICADO |
| Angustias | Ayuntamiento · ficha | Programa 2026 | VERIFICADO | VERIFICADO | VERIFICADO | VERIFICADO | AUSENTE | VERIFICADO | PARCIAL |
| San Pedro | Ayuntamiento · ficha | Programa 2026 | VERIFICADO | VERIFICADO | VERIFICADO | VERIFICADO | AUSENTE | VERIFICADO | VERIFICADO |
| Estudiantes | Ayuntamiento · ficha | Programa 2026 | VERIFICADO | VERIFICADO | VERIFICADO | VERIFICADO · sin Banda | AUSENTE | VERIFICADO | VERIFICADO |
| Dulce Nombre | Ayuntamiento · ficha | Programa 2026 | VERIFICADO | VERIFICADO | VERIFICADO | VERIFICADO | AUSENTE | VERIFICADO | VERIFICADO |
| Calvario | Ayuntamiento · ficha | Programa 2026 | VERIFICADO | VERIFICADO | VERIFICADO | VERIFICADO | AUSENTE | VERIFICADO | VERIFICADO |
...
Los bloques `AUSENTE` o `PARCIAL` no se convierten en datos mediante inferencia. El futuro lote nuclear puede cerrarse sin Cultos y sin Pasos de Gloria si las Fuentes específicas no aparecen.
...
- Banda de Música Villa de Osuna;
- cuatro autores ya canónicos;
- tres Fuentes ya vinculadas al Nazareno;
- dos Salidas extraordinarias de noviembre;
- relaciones nucleares del Nazareno que ya sean correctas.

### UPDATE

Previsión mínima:
- ficha `entities` / `brotherhoods` del Nazareno para completar identidad si procede;
- Paso del Nazareno actualmente en `review`;
- relación Hermandad–Paso existente, si la validación exige publicación;
- metadatos de la Imagen del Nazareno solo si la Fuente canónica lo justifica.
...
- quinta “Hermandad de Gloria” para la Inmaculada;
...
Estimación de trabajo **antes de staging**:
...
El municipio está **preparado para abrirse como quinto macrolote HC-016**, pero no para Apply.

Siguiente fase autorizable:

`preflight específico Estepa → cerrar incertidumbres → plan row-by-row → staging → preflight global`

Esta misión se detiene antes del staging.
